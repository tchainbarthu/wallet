...
export const PlatformPurchasing = () => {
    ...
    <div>
      {
        isLoading ? (<WaitingPage />) : (
          <div className="iphone-pro-platform-carbonA-purchasing">
      <div className="div-2">
        ...
        <Label className="label-instance" textKey="platform_purchasing_address" />
        <InputText className={`input-text-instance ${language}`} text="Account" onChange={e => { setTragetAddress(e.target.value); console.log('Account input changed:', e.target.value); }}/>
        </div>

        <div className="display-2">
        <Label className="design-component-instance-node" textKey="platform_purchasing_price"/>
        ...
        <Label className="design-component-instance-node" textKey="platform_deal_amount"/>
        <InputText className={`input-text-2 ${language}`} text="Account" onChange={e => { setAmount(e.target.value); console.log('Amount input changed:', e.target.value); }}/>
          </div>
        ...
        <Sbumit className="sbumit-instance" textKey="confirm" onClick={() => {handleClick(Amount, address, TragetAddress, sessionId, Balance,data, setIsLoading, navigate, setBalance)}} />
