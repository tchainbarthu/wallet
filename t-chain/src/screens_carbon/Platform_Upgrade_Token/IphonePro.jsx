...
async function fetchTokenList (sessionId, address){
  ...
  const token_list_fetch_template = {
    "jsonrpc": "3.0",
    "method": "chain_carbon",
     "params":[`opcode=carbon&subcode=showPendindToken&address=${platform_address}&op=0`,
       "encryp=none"],
        "id": `${sessionId}`};
...
export const PlatformUpgradeToken = () => {
  ...
  return (
    <div>
      ...
      <div className="div-2">
        ...
        <Sbumit className="sbumit-deploy-token" textKey="deploy_token" onClick={() => {navigate('/CarbonA/UpgradeToken')}} />
