  ...
  return (
    <div>
      ...
      <div className="div-2">
        ...
        <Label className="design-component-instance-node" textKey="type"/>
        <InputText className={`input-text-2 ${language}`} text="Account" onChange={e => { setAmount(e.target.value); console.log('Amount input changed:', e.target.value); }}/>
          </div>
        ...
        <Sbumit className="sbumit-instance" textKey="deploy" onClick={() => {handleClick(Amount, address, TragetAddress, sessionId, Balance,data, setIsLoading, navigate, setBalance)}} />
